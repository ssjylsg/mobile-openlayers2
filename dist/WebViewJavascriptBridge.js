...
(function() {
    ...
    function init(messageHandler) {
        ...
        for (var i = 0; i < receivedMessages.length; i++) {
            _dispatchMessageFromNative(receivedMessages[i].msg, receivedMessages[i].data);
        }
    }
    ...
    //提供给native使用,
    function _dispatchMessageFromNative(messageJSON, data) {
        setTimeout(function() {
            var message = JSON.parse(messageJSON);
            message.data = messageJSON.data || data;
    ...
    function _handleMessageFromNative(messageJSON) {
        ...
        if (receiveMessageQueue && receiveMessageQueue.length > 0) {
            ...
            _dispatchMessageFromNative(messageJSON, data);
        }
    }
