...
OpenLayers.Feature.Vector = OpenLayers.Class(OpenLayers.Feature, {
    ...
    _flashInterval: function(b) {
        if (this.flashTimes < this.flashCount) {
            this.flashTimes++;
            if (this.getVisibility()) {
                this.hide();
            } else {
        ...
        this.flashTimeOut = this.setTimeout("this._flashInterval()", 400);
    },
    setTimeout: function(ie, Bi) {
        var ke = "tempVar" + this._m_iSeq + "_" + this.id;
        this._m_iSeq++;
        if (this._m_iSeq === Number.MAX_VALUE - 1) {
            this._m_iSeq = 0;
        }
        eval(ke + " = this;");
    ...
    _setTimeoutDispatcher: function(ie) {
        eval(ie);
    },
