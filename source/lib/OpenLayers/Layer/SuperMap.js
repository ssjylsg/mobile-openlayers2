 ...
 */
OpenLayers.Layer.SuperMap = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    clone: function(obj) {
        ...
        if (obj == null) {
            obj = new OpenLayers.Layer.SuperMap(this.name,
                this.url,
                this.getOptions());
        }
    ...
    getURL: function(bounds) {
        ...
        var url = this.url instanceof Array ? this.url[(x + y + z) % this.url.length] : this.url;
        return url + path;
    },
